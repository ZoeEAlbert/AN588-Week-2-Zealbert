...
#this is a vector of srings from the first line of Ulysses.
v[seq(from = 1 , to = 22, by = 3)]
#Every third element of above vector.
```
#Challenge Two
```{r}
...
x <- m[,2:3]
x
# I cannot figure out how to get column 6. I can only do 2 and 3 becuase they are next to each other. 
x <-m [6:8,]
x
